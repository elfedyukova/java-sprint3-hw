...
public class TaskManager {
    ...
    public void deleteSubtaskById(int subtaskId) {
        System.out.println("проверка" + subtasks.get(subtaskId));//проверка{name = 'new name', details='new description', id='7', status='IN_PROGRESS'}
        System.out.println("проверка1" + epics); //epics.get(subtasks.get(subtaskId))
        System.out.println("проверка1" + subtasks);
        System.out.println("проверка3" + epics.get(getSubtaskById(subtaskId)));
